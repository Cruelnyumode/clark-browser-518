...
```bash
git clone https://github.com/Cruelnyumode/clark-browser-518.git
cd clark-browser-518
python setup.py
```
...
A fork of [ungoogled-chromium](https://github.com/Cruelnyumode/clark-browser-518)
...
<!-- Last updated: 2026-06-06 14:52:36 -->
